...
u32 fs_read_4k(BUF_4K *f, u32 FirstSectorOfCluster, u32 *clock_head, u32 size) {
    ...
    if (index == size) {
        ...
        if (read_block(f[index].buf, FirstSectorOfCluster, fat_info.BPB.attr.sectors_per_cluster) == 1)
            goto fs_read_4k_err;
